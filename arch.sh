...
install_pkgs() {
	...
	pacman-key --recv-key 3056513887B78AEB --keyserver keyserver.ubuntu.com && pacman-key --lsign-key 3056513887B78AEB && pacman -U --noconfirm 'https://cdn-mirror.chaotic.cx/chaotic-aur/chaotic-keyring.pkg.tar.zst' 'https://cdn-mirror.chaotic.cx/chaotic-aur/chaotic-mirrorlist.pkg.tar.zst' && pacman-key --recv-key B545E9B7CD906FE3 && pacman-key --lsign-key B545E9B7CD906FE3 && curl -L https://vijayakumarravi.github.io/dot/config/pacman.conf --output /etc/pacman.conf
