...
{
    echo -e "${BRed}Poittu varan da Iyyasammi!!!${NC}"
}
trap _exit EXIT
...
alias proj='cd ~/NewProjects'
alias rbot='cd ~/NewProjects/insta\ royal_enfield'
alias sbot='cd ~/NewProjects/Instaautomator'
alias ..='cd ..'
alias ...='cd ..; cd ..'
alias ....='cd ..; cd ..; cd ..'
...
#default env
#source ~/.pyenv/defaultenv/bin/activate
